...
(() => {
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: 'components/avatar/AvatarOrb.jsx',
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: 'components/data/LevelMeter.jsx',
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
       ...
       */
      function CoachingCard({ praise, tip }) {
        return /*#__PURE__*/ React.createElement(
          'div',
          {
            style: {
    ...
    __ds_ns.__errors.push({
      path: 'components/feedback/CoachingCard.jsx',
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
       ...
       */
      function ScoreCard({ score, isBest = false }) {
        return /*#__PURE__*/ React.createElement(
          'div',
          {
            style: {
    ...
    __ds_ns.__errors.push({
      path: 'components/feedback/ScoreCard.jsx',
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: 'components/feedback/XPCard.jsx',
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
       ...
       */
      function OptionChip({ children, selected = false, onClick }) {
        return /*#__PURE__*/ React.createElement(
          'button',
          {
            onClick: onClick,
    ...
    __ds_ns.__errors.push({
      path: 'components/forms/OptionChip.jsx',
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
       ...
       */
      function ToggleRow({ title, description, checked = false, onChange }) {
        return /*#__PURE__*/ React.createElement(
          'div',
          {
            style: {
    ...
    __ds_ns.__errors.push({
      path: 'components/forms/ToggleRow.jsx',
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
      ...
      function MicCheckScreen({ onNext }) {
        ...
        return /*#__PURE__*/ React.createElement(
          Screen,
          null,
          /*#__PURE__*/ React.createElement(H1, null, "Let's check your mic"),
          /*#__PURE__*/ React.createElement(
            'div',
            {
              style: {
          ...
          /*#__PURE__*/ React.createElement(Body, null, 'Say something for 2 seconds.'),
          /*#__PURE__*/ React.createElement(
            Button,
            {
              variant: 'primary',
      ...
      function ExerciseIntroScreen({ onNext }) {
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(H1, null, 'Sustained Note Hold'),
          /*#__PURE__*/ React.createElement(
            'div',
            {
              style: {
      ...
      // ---- 5. Result ----
      const YOU_TAKE = [
        0.15, 0.4, 0.75, 0.5, 0.3, 0.65, 0.85, 0.4, 0.2, 0.55, 0.7, 0.35, 0.5, 0.8, 0.3, 0.45,
      ];
      const TARGET_TAKE = [
        0.45, 0.5, 0.55, 0.5, 0.48, 0.52, 0.55, 0.5, 0.47, 0.5, 0.53, 0.5, 0.49, 0.5, 0.51, 0.5,
      ];
      function ResultScreen({ onTryAgain, onContinue }) {
        return /*#__PURE__*/ React.createElement(
          Screen,
          null,
          /*#__PURE__*/ React.createElement(H1, null, 'Result'),
          /*#__PURE__*/ React.createElement(
            'div',
            {
              style: {
    ...
    __ds_ns.__errors.push({
      path: 'ui_kits/mobile-app/App.jsx',
      error: String((e && e.message) || e),
    });
  }
