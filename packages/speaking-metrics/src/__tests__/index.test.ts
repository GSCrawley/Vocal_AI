...
describe('scorePace', () => {
  it('uses presentation as default context', () => {
    expect(scorePace(160)).toEqual(90);
  });
  ...
  it('scores within acceptable range based on proximity', () => {
    expect(scorePace(150, 'presentation')).toEqual(97);
    expect(scorePace(140, 'presentation')).toEqual(97);
    expect(scorePace(185, 'presentation')).toEqual(30);
  });

  it('scores outside acceptable range by degrading linearly (too slow)', () => {
    expect(scorePace(139, 'presentation')).toEqual(96);
    expect(scorePace(130, 'presentation')).toEqual(90);
  });

  it('scores outside acceptable range by degrading linearly (too fast)', () => {
    expect(scorePace(186, 'presentation')).toEqual(28);
    expect(scorePace(190, 'presentation')).toEqual(20);
  });

  it('scores exactly 0 when very far outside range rather than negative', () => {
    expect(scorePace(100, 'presentation')).toEqual(30);
