...
export type SingingStylePack = 'pop' | 'jazz' | 'blues' | 'classical_opera' | 'musical_theatre' | 'rnb_soul' | 'rock' | 'heavy_metal' | 'grindcore' | 'country' | 'gospel';
...
export type ExerciseCategory = 'breathing' | 'pace_control' | 'prosody' | 'projection' | 'resonance_speaking' | 'articulation' | 'filler_reduction' | 'authority_delivery' | 'speaking_stamina' | 'pitch_matching' | 'sustained_hold' | 'scale_work' | 'interval_training' | 'passaggio' | 'dynamic_control' | 'vibrato' | 'style_specific' | 'karaoke_snippet';
export type TargetPatternType = 'sustained_hold' | 'scale_ascending' | 'scale_descending' | 'interval_jump' | 'passage_read' | 'free_speech' | 'phrase_sing' | 'karaoke_snippet' | 'breath_only' | 'hum_resonance';
